...
/* From Uiverse.io by mymiamo — adaptado: navbar superior fija,
   colores de marca, tema claro/oscuro y responsive */
    ...
    <>
      <style>{`
        .menu {
          ...
          width: calc(100% - 20px);
          max-width: 620px;
          backdrop-filter: blur(12px) saturate(180%) contrast(150%);
          -webkit-backdrop-filter: blur(12px) saturate(180%) contrast(150%);
        ...
        /* Responsive: en móvil se ocultan los textos y la marca se compacta */
      ...
      <nav className="menu" aria-label="Navegación principal">
        <div className="menu-brand">Stock<span style={{ WebkitTextFillColor: 'var(--accent)' }}>AI</span></div>

        <div className="menu-links">
          <a href="#" className="active" aria-label="Inicio">
          ...
          <a href="#features" aria-label="Características">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
